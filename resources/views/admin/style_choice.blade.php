                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">New Arrive Banner</a></li>
                                <li class="breadcrumb-item active">New Arrive Banner</li>
                            </ol>
                        </div>
                        <h4 class="page-title">New Arrive Banner</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    $.ajax({
                        ...
                        success: function(response)
                        {
                            ...
                            if (response.data.image == null || response.data.image == '') {
                                ...
                                $('#up_uploaded-image').attr('src', 'uploads/style_choices/' + response.data.image);
                            }

        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Main Banner</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Add New Banner</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="link" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
            ...
            <div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Update Banner</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                        </div>
                        <div class="modal-body p-3">
                            <form id="update_form">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Link</label>
                                            <input type="text" class="form-control" id="link" name="link" placeholder="Enter name">
                                            <input type="hidden" class="form-control" id="banner_id" name="banner_id" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div style="text-align:center; margin-top: 10px;">
        ...
        <script>
            $(document).ready(function(){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if (response.status == 200) {
                                    toastr.success('Banner Saved Successfully!', 'Successfull!');
                    ...
                    $.ajax({
                        ...
                        success: function(response)
                        {
                            ...
                            if (response.data.image == null || response.data.image == '') {
                                ...
                                $('#up_uploaded-image').attr('src', 'uploads/banner_images/' + response.data.image);
                            }
                    ...
                    if($("#update_form").valid()){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                console.log(response);
                                if (response.status == 200) {
                                    toastr.success('Banner Updated Successfully!', 'Successfull!');
                ...
                $(document).on("click", '#delete_btn', function(event){
                    ...
                    Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                var element = this;
                                $.ajax({
                                    url: '/delete_main_banner/'+id,
                                    type : "GET",
                                    success : function(response){
                                        if (response.status == 200)
                                        {
                                            toastr.success('Banner Has Been Deleted Seccussfully!', 'Successfull!');
                                            loadData();
                                        }else {
                                            Swal.fire({
                ...
                var defaultOptions = {
                    ...
                    order: [0, 'asc'],
                    columnDefs: [
                        { className: 'text-center td-30', targets: [0, 1, 3] },
                        // Add more column definitions as needed
                    ],
                    centeredColumnsOnPrintPdf: [0, 1, 3],

                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Lens Selection</a></li>
                                <li class="breadcrumb-item active">Lens Selection</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Lens Selection</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            $(document).ready(function(){
                ...
                $("#add_btn").click(function(e){
                    ...
                    if($("#add_form").valid()){
                        ...
                        $.ajax({
                            url: '{{ route("insert_lens_selection") }}',
                            method: 'post',
                            data : formData,
                            contentType : false,
                            processData : false,
                    ...
                    $.ajax({
                        ...
                        success: function(response)
                        {
                            ...
                            if (response.data.image == null || response.data.image == '') {
                                ...
                                $('#up_uploaded-image').attr('src', 'uploads/lens_selection/' + response.data.image);
                            }
                ...
                $("#update_btn").click(function(e){
                    ...
                    if($("#update_form").valid()){
                        ...
                        $.ajax({
                            url: '{{ route("update_lens_selection") }}',
                            method: 'post',
                            data : formData,
                            contentType : false,
                            processData : false,

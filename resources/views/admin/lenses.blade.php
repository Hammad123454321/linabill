        ...
        <div class="container-fluid">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-lg-end">
                                        <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#add_modal"><i class="fas fa-user me-1"></i> Add New Lens</button>
                                    </div>
                                </div><!-- end col-->
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Add New Lens</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="lens_name" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Description</label>
                                            <input type="text" class="form-control" name="lens_description" placeholder="Lens Description">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Tool Tip</label>
                                            <input type="text" class="form-control" name="lens_tool_tip" placeholder="Lens Tool Tip">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Price</label>
                                            <input type="number" class="form-control" name="lens_price" placeholder="Lens Price">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
            ...
            <div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Update Lens</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                        </div>
                        <div class="modal-body p-3">
                            <form id="update_form">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="hidden" id="lens_id" name="lens_id">
                                            <label for="name" class="form-label">Coating Name</label>
                                            <input type="text" class="form-control" name="lens_name" id="lens_name" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Description</label>
                                            <input type="text" class="form-control" id="lens_description" name="lens_description" placeholder="Lens Description">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Tool Tip</label>
                                            <input type="text" class="form-control" id="lens_tool_tip" name="lens_tool_tip" placeholder="Lens Tool Tip">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Lens Price</label>
                                            <input type="number" class="form-control" id="lens_price" name="lens_price" placeholder="Lens Price">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div style="text-align:center; margin-top: 10px;">
            ...
            $(document).ready(function(){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if (response.status == 200) {
                                    toastr.success('Lens Saved Successfully!', 'Successfull!');
                ...
                $(document).on("click", '#edit_btn', function(event){
                    ...
                    $.ajax({
                        ...
                        {
                            console.log(response);
                            $('#lens_id').val(response.data.id);
                            $('#lens_name').val(response.data.lens_name);
                            $('#lens_description').val(response.data.lens_description);
                            $('#lens_tool_tip').val(response.data.lens_tool_tip);
                            $('#lens_price').val(response.data.lens_price);

                            if (response.data.lens_image == null || response.data.lens_image == '') {
                                $('#up_uploaded-image').attr('src', 'uploads/no_image.jpg');
                            } else {
                                $('#up_uploaded-image').attr('src', 'uploads/lens_images/' + response.data.lens_image);
                            }
                    ...
                    if($("#update_form").valid()){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                console.log(response);
                                if (response.status == 200) {
                                    toastr.success('Lens Data Updated Successfully!', 'Successfull!');
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    success : function(response){
                                        if (response.status == 200)
                                        {
                                            toastr.success('Lens Has Been Deleted Seccussfully!', 'Successfull!');
                                            loadData();
                                        }else {
                                            Swal.fire({
                ...
                var defaultOptions = {
                    ...
                    columnDefs: [
                        { className: 'text-center td-30', targets: [0, 1, 2, 4, 5, 6, 7] },
                        // Add more column definitions as needed
                    ],
                    centeredColumnsOnPrintPdf: [0, 1, 2, 4, 5, 6, 7],

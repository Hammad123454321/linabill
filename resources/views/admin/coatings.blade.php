        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Coatings</a></li>
                                <li class="breadcrumb-item active">Coatings</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Coatings</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-lg-end">
                                        <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#add_modal"><i class="fas fa-user me-1"></i> Add New Coating</button>
                                    </div>
                                </div><!-- end col-->
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Add New Coating</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="coating_name" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Coating Description</label>
                                            <input type="text" class="form-control" name="coating_description" placeholder="Coating Description">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Coating Price</label>
                                            <input type="number" class="form-control" name="coating_price" placeholder="Coating Price">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
            ...
            <div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Update Coating</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                        </div>
                        <div class="modal-body p-3">
                            <form id="update_form">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="hidden" id="coating_id" name="coating_id">
                                            <label for="name" class="form-label">Coating Name</label>
                                            <input type="text" class="form-control" name="coating_name" id="coating_name" placeholder="Enter name">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Coating Description</label>
                                            <input type="text" class="form-control" id="coating_description" name="coating_description" placeholder="Coating Description">
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <div class="form-group">
                                            <label for="name" class="form-label">Coating Price</label>
                                            <input type="number" class="form-control" id="coating_price" name="coating_price" placeholder="Coating Price">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div style="text-align:center; margin-top: 10px;">
            ...
            $(document).ready(function(){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if (response.status == 200) {
                                    toastr.success('Coating Saved Successfully!', 'Successfull!');
                                    ...
                                    Swal.fire({ 
                                            title: "Coating Exist!",
                                            text: "This Coating Already Excst!",
                                            icon: "error", 
                                            buttonsStyling: !1,
                ...
                $(document).on("click", '#edit_btn', function(event){
                    ...
                    $.ajax({
                        ...
                        {
                            console.log(response);
                            $('#coating_id').val(response.data.id);
                            $('#coating_name').val(response.data.coating_name);
                            $('#coating_description').val(response.data.coating_description);
                            $('#coating_price').val(response.data.coating_price);

                            if (response.data.coating_image == null || response.data.coating_image == '') {
                                $('#up_uploaded-image').attr('src', 'uploads/no_image.jpg');
                            } else {
                                $('#up_uploaded-image').attr('src', 'uploads/coating_images/' + response.data.coating_image);
                            }
                    ...
                    if($("#update_form").valid()){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                console.log(response);
                                if (response.status == 200) {
                                    toastr.success('Coating Data Updated Successfully!', 'Successfull!');
                                    ...
                                    Swal.fire({ 
                                            title: "Coating Exist!",
                                            text: "This Coating Already Exist!",
                                            icon: "error", 
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: { 
                ...
                $(document).on("click", '#delete_btn', function(event){
                    ...
                    Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                var element = this;
                                $.ajax({
                                    url: '/delete_coating/'+id,
                                    type : "GET",
                                    success : function(response){
                                        if (response.status == 200)
                                        {
                                            toastr.success('Coating Has Been Deleted Seccussfully!', 'Successfull!');
                                            loadData();
                                        }else {
                                            Swal.fire({
                ...
                var defaultOptions = {
                    ...
                    columnDefs: [
                        { className: 'text-center td-30', targets: [0, 1, 2, 4, 5, 6] },
                        // Add more column definitions as needed
                    ],
                    centeredColumnsOnPrintPdf: [0, 1, 2, 4, 5, 6],

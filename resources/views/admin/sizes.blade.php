        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Sizes</a></li>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-4">
                                    <div class="text-lg-end">
                                        <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#add_modal"><i class="fas fa-user me-1"></i> Add New Size</button>
                                    </div>
                                </div><!-- end col-->
                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Add New Size</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="size_name" placeholder="Enter name">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="update_modal" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        <div class="modal-header bg-light">
                            <h4 class="modal-title" id="myCenterModalLabel">Update Size</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                        </div>
                        <div class="modal-body p-3">
                            <form id="update_form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label for="name" class="form-label">Size Name</label>
                                                    <input type="text" class="form-control" name="size_name" id="size_name" placeholder="Enter name">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            $(document).ready(function(){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if (response.status == 200) {
                                    toastr.success('Size Saved Successfully!', 'Successfull!');
                ...
                $(document).on("click", '#edit_btn', function(event){
                    ...
                    $.ajax({
                        ...
                        {
                            console.log(response);
                            $('#size_id').val(response.data.id);
                            $('#size_name').val(response.data.size_name);
                    ...
                    if($("#update_form").valid()){
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                console.log(response);
                                if (response.status == 200) {
                                    toastr.success('Size Data Updated Successfully!', 'Successfull!');
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    ...
                                    success : function(response){
                                        if (response.status == 200)
                                        {
                                            toastr.success('Size Has Been Deleted Seccussfully!', 'Successfull!');
                                            loadData();
                                        }else {
                                            Swal.fire({
                ...
                var defaultOptions = {
                    ...
                    columnDefs: [
                        { className: 'text-center td-30', targets: [0, 1, 2, 3] },
                        // Add more column definitions as needed
                    ],
                    centeredColumnsOnPrintPdf: [0, 1, 2, 3],

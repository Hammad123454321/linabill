                    ...
                    $.ajax({
                        ...
                        success: function(response)
                        {
                            ...
                            if (response.data.image == null || response.data.image == '') {
                                ...
                                $('#up_uploaded-image').attr('src', 'uploads/new_arrive_banner/' + response.data.image);
                            }

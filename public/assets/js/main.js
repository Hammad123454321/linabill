(function ($) {
  ...
  // ========================= hot deals Slider Js Start ==============
   $('.feature-item-wrapper1').slick({
    ...
    speed: 900,
    infinite: true,
    nextArrow: '#feature-item-wrapper-next1',
    prevArrow: '#feature-item-wrapper-prev1',
    responsive: [
      {
        breakpoint: 1699,
        settings: {
  ...
  $('.deals-week-slider1').slick({
    ...
    speed: 900,
    infinite: true,
    nextArrow: '#deal-week-next1',
    prevArrow: '#deal-week-prev1',
    responsive: [
      {
        breakpoint: 1599,
        settings: {
...
// ========================= hot deals Slider Js End ===================
    ...
    responsive: [
            {
                ...
                settings: {
                    vertical: false, // Disable vertical mode on mobile
                    slidesToShow: 4, // Show 3 thumbnails on mobile
                    slidesToScroll: 1,
                    arrows: false
                }
            }
  ...
  $('.color-list__button').on('click', function () {
    $('.color-list__button').removeClass('border-main-600'); 

    if(!$(this).hasClass('border-main-600')) {
      $(this).addClass('border-main-600');
